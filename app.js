...
var budgetController = (function () {
	...
	return {
		...
		calculateBudget: function () {
			...
			// Calculate the income percentage of the income that we spent
	 ...
	 getInput: function (){
	  ...
	  addListItem: function (obj, type) {
        ...
        html = '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div></div></div>';            
	  	...
	  	// then replace plaxceholder tect with actual data
...
var ctrlAddItem = function () {
	//After the button is clicked we need to....
	var newItem, input;
	...
	//6. Caculatre and update the percentages
	updatePercentages();
	...
	var ctrlDeleteItem = function (event) {
		...
		if (itemID) {
			...
			//3. Updte and show the new budget
			updateBudget();
			//4. Caculatre and update the percentages
			updatePercentages();
		}
